...
import com.c3.g7.entity.Discount;
import com.c3.g7.helper.ResponseMessage;
...
public class DiscountController {
	...
	public ResponseEntity<ResponseMessage> createCoupon(@PathVariable("code") String code,@RequestBody List<String> emails) {
    	...
    	String url="http://localhost:8081/c3g7/add/coupon/"+code;
    ...
    public List<Discount> orderList() {
    	...
    	String url="http://localhost:8081/c3g7/coupon/alllist";
	...
	public ResponseEntity<Discount> deleteCoupon(@PathVariable("code") Long code) {
    	...
    	String url="http://localhost:8081/c3g7/delete/coupon/"+code;
